# backend-lemon
Micro serviço desenvolvido em Node+Express, fazendo as validações do JSON e a regra de negócio.
Utilizar rota POST /elegibilidade, fornecendo um JSON de acordo com os exemplos abaixo.
Testes de integração desenvolvidos com Jest e Supertest
